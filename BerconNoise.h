...
class BerconNoise : public Texmap, public ResourceMakerCallback/*, public imrShaderTranslation*/ {
	...
	{
		ICurve* p_curve{ pCCtl->GetControlCurve(curvenum) };
		if (p_curve)
		{
			p_curve->SetNumPts(2);
	...
	void NewCurveCreatedCallback(int curvenum, ICurveCtl* pCCtl)
	{
		...
		IParamBlock2* GetParamBlock(int i) { switch (i) { case 0: return pblock; case 1: return pbCurve; case 2: return pbMap; case 3: return pbXYZ; } return pblock; }
...
public:
	BerconNoiseClassDesc() {}
	virtual ~BerconNoiseClassDesc() {}
