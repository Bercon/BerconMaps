...
class BerconWood : public Texmap, public ResourceMakerCallback {
	...
	public:
		...
		void ResetCallback(int curvenum, ICurveCtl *pCCtl) { ICurve *pCurve; pCurve = pCCtl->GetControlCurve(curvenum); if(pCurve) { pCurve->SetNumPts(2); NewCurveCreatedCallback(curvenum, pCCtl); }}
	...
	//	int NumSubs() { return NUMREF; }			// Max will take care of its own tracking of how many submaps, and how many references
		Animatable* SubAnim(int i); 
		TSTR SubAnimName(int i);				

	//	int NumRefs() { return NUMREF; }			// Max will take care of its own tracking of how many submaps, and how many references
