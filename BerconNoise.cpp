...
static ParamBlockDesc2 berconnoise_param_blk(berconnoise_params, _M("params"), 0, &BerconNoiseDesc,
                                             ...
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_NOISESIZE_EDIT, IDC_NOISESIZE_SPIN,
                                             SPIN_AUTOSCALE,
                                             p_end,
                                             noise_lowthresh, _M("thresholdLow"), TYPE_FLOAT, P_ANIMATABLE,
                                             IDS_RB_LOWTHRESH,
                                             p_default, 0.0f,
                                             p_range, 0.0f, 1000.0f,
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_NOISE_LOWTHRESH,
                                             IDC_NOISE_LOWTHRESHSPIN, SPIN_AUTOSCALE,
                                             p_end,
                                             noise_hithresh, _M("thresholdHigh"), TYPE_FLOAT, P_ANIMATABLE,
                                             IDS_RB_HIGHTHRESH,
                                             p_default, 1.0f,
                                             p_range, 0.0f, 1000.0f,
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_NOISE_HIGHTHRESH,
                                             IDC_NOISE_HIGHTHRESHSPIN, SPIN_AUTOSCALE,
                                             p_end,
                                             ...
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_NOISEPHASE_EDIT,
                                             IDC_NOISEPHASE_SPIN, SPIN_AUTOSCALE,
                                             p_end,
                                             ...
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_F1_EDIT, IDC_F1_SPIN,
                                             SPIN_AUTOSCALE,
                                             p_end,
                                             worley_F2, _M("wF2"), TYPE_FLOAT, P_ANIMATABLE, IDS_WORLEY_F2,
                                             p_default, 0.0f,
                                             p_range, -1000.0f, 1000.0f,
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_F2_EDIT, IDC_F2_SPIN,
                                             SPIN_AUTOSCALE,
                                             p_end,
                                             worley_F3, _M("wF3"), TYPE_FLOAT, P_ANIMATABLE, IDS_WORLEY_F3,
                                             p_default, 0.0f,
                                             p_range, -1000.0f, 1000.0f,
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_F3_EDIT, IDC_F3_SPIN,
                                             SPIN_AUTOSCALE,
                                             p_end,
                                             worley_F4, _M("wF4"), TYPE_FLOAT, P_ANIMATABLE, IDS_WORLEY_F4,
                                             p_default, 0.0f,
                                             p_range, -1000.0f, 1000.0f,
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_F4_EDIT, IDC_F4_SPIN,
                                             SPIN_AUTOSCALE,
                                             p_end,
                                             worley_spread, _M("worleySpread"), TYPE_FLOAT, P_ANIMATABLE,
                                             IDS_WORLEY_SPREAD,
                                             p_default, 3.0f,
                                             p_range, 0.0f, 1000.0f,
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_WORLEY_EDIT, IDC_WORLEY_SPIN,
                                             SPIN_AUTOSCALE,
                                             p_end,
                                             ...
                                             p_default, 3.0f,
                                             p_range, 1.0f, 20.0f,
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_NOISELEV_EDIT, IDC_NOISELEV_SPIN,
                                             SPIN_AUTOSCALE,
                                             p_end,
                                             fractal_gain, _M("fractalGain"), TYPE_FLOAT, P_ANIMATABLE,
                                             IDS_FRACTAL_GAIN,
                                             p_default, 0.0f,
                                             p_range, 0.0f, 100.0f,
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_FRACTAL_GAIN_EDIT,
                                             IDC_FRACTAL_GAIN_SPIN, SPIN_AUTOSCALE,
                                             p_end,
                                             fractal_offset, _M("fractalOffset"), TYPE_FLOAT, P_ANIMATABLE,
                                             IDS_FRACTAL_OFFSET,
                                             p_default, 0.0f,
                                             p_range, 0.0f, 100.0f,
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_FRACTAL_OFFSET_EDIT,
                                             IDC_FRACTAL_OFFSET_SPIN, SPIN_AUTOSCALE,
                                             p_end,
                                             fractal_h, _M("fractalH"), TYPE_FLOAT, P_ANIMATABLE, IDS_FRACTAL_H,
                                             p_default, 0.0f,
                                             p_range, 0.0f, 100.0f,
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_FRACTAL_H_EDIT, IDC_FRACTAL_H_SPIN,
                                             SPIN_AUTOSCALE,
                                             p_end,
                                             fractal_lacunarity, _M("fractalLacunarity"), TYPE_FLOAT, P_ANIMATABLE,
                                             IDS_FRACTAL_LACUNARITY,
                                             p_default, 0.0f,
                                             p_range, 0.0f, 100.0f,
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_FRACTAL_LACUNARITY_EDIT,
                                             IDC_FRACTAL_LACUNARITY_SPIN, SPIN_AUTOSCALE,
                                             p_end,
                                             ...
                                             p_end,
                                             distortion_map2, _M("map4"), TYPE_TEXMAP, P_OWNERS_REF,
                                             IDS_DISTORTION_MAP2,
                                             p_refno, MAP4_REF,
                                             p_subtexno, 3,
                                             p_ui, TYPE_TEXMAPBUTTON, IDC_DISTORTION_TE2,
                                             p_end,
                                             distortion_str, _M("distortionStr"), TYPE_FLOAT, P_ANIMATABLE,
                                             IDS_DISTORTION_STRENGTH,
                                             p_default, 0.1f,
                                             p_range, 0.0f, 1000.0f,
                                             p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_DISTORTION_EDIT,
                                             IDC_DISTORTION_SPIN, SPIN_AUTOSCALE,
                                             p_end,
...
static ParamBlockDesc2 BerconMap_param_blk(BerconMap_params, _M("params"), 0, &BerconNoiseDesc,
                                           ...
                                           map1, _M("bmap1"), TYPE_TEXMAP, P_OWNERS_REF, IDS_MAP1, p_refno, BMAP1_REF,
                                           p_subtexno, BMAP1_NUM, p_ui, TYPE_TEXMAPBUTTON, IDC_MAP1, p_end, mapOn1,
                                           _M("bmap1Enabled"), TYPE_BOOL, 0, IDS_MAPON1, p_default, TRUE, p_ui,
                                           TYPE_SINGLECHEKBOX, IDC_MAPON1, p_end,
                                           map2, _M("bmap2"), TYPE_TEXMAP, P_OWNERS_REF, IDS_MAP2, p_refno, BMAP2_REF,
                                           p_subtexno, BMAP2_NUM, p_ui, TYPE_TEXMAPBUTTON, IDC_MAP2, p_end, mapOn2,
                                           _M("bmap2Enabled"), TYPE_BOOL, 0, IDS_MAPON2, p_default, TRUE, p_ui,
                                           TYPE_SINGLECHEKBOX, IDC_MAPON2, p_end,
                                           map3, _M("bmap3"), TYPE_TEXMAP, P_OWNERS_REF, IDS_MAP3, p_refno, BMAP3_REF,
                                           p_subtexno, BMAP3_NUM, p_ui, TYPE_TEXMAPBUTTON, IDC_MAP3, p_end, mapOn3,
                                           _M("bmap3Enabled"), TYPE_BOOL, 0, IDS_MAPON3, p_default, TRUE, p_ui,
                                           TYPE_SINGLECHEKBOX, IDC_MAPON3, p_end,
                                           map4, _M("bmap4"), TYPE_TEXMAP, P_OWNERS_REF, IDS_MAP4, p_refno, BMAP4_REF,
                                           p_subtexno, BMAP4_NUM, p_ui, TYPE_TEXMAPBUTTON, IDC_MAP4, p_end, mapOn4,
                                           _M("bmap4Enabled"), TYPE_BOOL, 0, IDS_MAPON4, p_default, TRUE, p_ui,
                                           TYPE_SINGLECHEKBOX, IDC_MAPON4, p_end,
                                           map5, _M("bmap5"), TYPE_TEXMAP, P_OWNERS_REF, IDS_MAP5, p_refno, BMAP5_REF,
                                           p_subtexno, BMAP5_NUM, p_ui, TYPE_TEXMAPBUTTON, IDC_MAP5, p_end, mapOn5,
                                           _M("bmap5Enabled"), TYPE_BOOL, 0, IDS_MAPON5, p_default, TRUE, p_ui,
                                           TYPE_SINGLECHEKBOX, IDC_MAPON5, p_end,
                                           map6, _M("bmap6"), TYPE_TEXMAP, P_OWNERS_REF, IDS_MAP6, p_refno, BMAP6_REF,
                                           p_subtexno, BMAP6_NUM, p_ui, TYPE_TEXMAPBUTTON, IDC_MAP6, p_end, mapOn6,
                                           _M("bmap6Enabled"), TYPE_BOOL, 0, IDS_MAPON6, p_default, TRUE, p_ui,
                                           TYPE_SINGLECHEKBOX, IDC_MAPON6, p_end,
                                           map7, _M("bmap7"), TYPE_TEXMAP, P_OWNERS_REF, IDS_MAP7, p_refno, BMAP7_REF,
                                           p_subtexno, BMAP7_NUM, p_ui, TYPE_TEXMAPBUTTON, IDC_MAP7, p_end, mapOn7,
                                           _M("bmap7Enabled"), TYPE_BOOL, 0, IDS_MAPON7, p_default, TRUE, p_ui,
                                           TYPE_SINGLECHEKBOX, IDC_MAPON7, p_end,
                                           map8, _M("bmap8"), TYPE_TEXMAP, P_OWNERS_REF, IDS_MAP8, p_refno, BMAP8_REF,
                                           p_subtexno, BMAP8_NUM, p_ui, TYPE_TEXMAPBUTTON, IDC_MAP8, p_end, mapOn8,
                                           _M("bmap8Enabled"), TYPE_BOOL, 0, IDS_MAPON8, p_default, TRUE, p_ui,
                                           TYPE_SINGLECHEKBOX, IDC_MAPON8, p_end,
                                           map9, _M("bmap9"), TYPE_TEXMAP, P_OWNERS_REF, IDS_MAP9, p_refno, BMAP9_REF,
                                           p_subtexno, BMAP9_NUM, p_ui, TYPE_TEXMAPBUTTON, IDC_MAP9, p_end, mapOn9,
                                           _M("bmap9Enabled"), TYPE_BOOL, 0, IDS_MAPON9, p_default, TRUE, p_ui,
                                           TYPE_SINGLECHEKBOX, IDC_MAPON9, p_end,
                                           map10, _M("bmap10"), TYPE_TEXMAP, P_OWNERS_REF, IDS_MAP10, p_refno,
                                           BMAP10_REF, p_subtexno, BMAP10_NUM, p_ui, TYPE_TEXMAPBUTTON, IDC_MAP10,
                                           p_end, mapOn10, _M("bmap10Enabled"), TYPE_BOOL, 0, IDS_MAPON10, p_default,
                                           TRUE, p_ui, TYPE_SINGLECHEKBOX, IDC_MAPON10, p_end,
                                           map11, _M("bmap11"), TYPE_TEXMAP, P_OWNERS_REF, IDS_MAP11, p_refno,
                                           BMAP11_REF, p_subtexno, BMAP11_NUM, p_ui, TYPE_TEXMAPBUTTON, IDC_MAP11,
                                           p_end, mapOn11, _M("bmap11Enabled"), TYPE_BOOL, 0, IDS_MAPON11, p_default,
                                           TRUE, p_ui, TYPE_SINGLECHEKBOX, IDC_MAPON11, p_end,
                                           map12, _M("bmap12"), TYPE_TEXMAP, P_OWNERS_REF, IDS_MAP12, p_refno,
                                           BMAP12_REF, p_subtexno, BMAP12_NUM, p_ui, TYPE_TEXMAPBUTTON, IDC_MAP12,
                                           p_end, mapOn12, _M("bmap12Enabled"), TYPE_BOOL, 0, IDS_MAPON12, p_default,
                                           TRUE, p_ui, TYPE_SINGLECHEKBOX, IDC_MAPON12, p_end,
                                           map13, _M("bmap13"), TYPE_TEXMAP, P_OWNERS_REF, IDS_MAP13, p_refno,
                                           BMAP13_REF, p_subtexno, BMAP13_NUM, p_ui, TYPE_TEXMAPBUTTON, IDC_MAP13,
                                           p_end, mapOn13, _M("bmap13Enabled"), TYPE_BOOL, 0, IDS_MAPON13, p_default,
                                           TRUE, p_ui, TYPE_SINGLECHEKBOX, IDC_MAPON13, p_end,
                                           map14, _M("bmap14"), TYPE_TEXMAP, P_OWNERS_REF, IDS_MAP14, p_refno,
                                           BMAP14_REF, p_subtexno, BMAP14_NUM, p_ui, TYPE_TEXMAPBUTTON, IDC_MAP14,
                                           p_end, mapOn14, _M("bmap14Enabled"), TYPE_BOOL, 0, IDS_MAPON14, p_default,
                                           TRUE, p_ui, TYPE_SINGLECHEKBOX, IDC_MAPON14, p_end,
...
public:
	...
	{
		if (berconNoise->cc_curve->GetHWND() != GetDlgItem(hWnd, IDC_CURVE))
			CurveCtrl::update(
				berconNoise->cc_curve, GetDlgItem(hWnd, IDC_CURVE), dynamic_cast<ReferenceMaker*>(berconNoise));
		// Force update cc_curve
		switch (msg)
		{
		case WM_INITDIALOG:
			CurveCtrl::init;
			return TRUE;
		case WM_DESTROY:
			CurveCtrl::disable(berconNoise->cc_curve);
			break;
		case WM_SHOWWINDOW:
			CurveCtrl::update(berconNoise->cc_curve, GetDlgItem(hWnd, IDC_CURVE),
			                  dynamic_cast<ReferenceMaker*>(berconNoise));
			break;
	...
	{
		CurveCtrl::disable(berconNoise->cc_curve); // Disable previously used cc_curve
...
INT_PTR BerconNoiseDlgProc::DlgProc(TimeValue t, IParamMap2* map, HWND hWnd, UINT msg, WPARAM /*wParam*/,
                                    LPARAM /*lParam*/)
{
	switch (msg)
	{
...
void BerconNoise::Reset()
{
	...
	if (cc_curve) cc_curve->DeleteMe();
	cc_curve = static_cast<ICurveCtl *>(CreateInstance(REF_MAKER_CLASS_ID,CURVE_CONTROL_CLASS_ID));

	cc_curve->RegisterResourceMaker(dynamic_cast<ReferenceTarget*>(this));

	CurveCtrl::init(cc_curve);
	...
	pblock->SetValue(noise_map1_on, t, 1.f);
	pblock->SetValue(noise_map2_on, t, 1.f);
	pblock->SetValue(distortion_str, t, .1f);
	pblock->SetValue(use_distortion, t, 0.f);
...
void BerconNoise::EnableStuff()
{
	if (pblock)
	{
		...
		if (map)
		{
			...
			pblock->GetValue(use_distortion, 0, useDistortion, Interval(TimeValue(0x80000000), TimeValue(0x7fffffff)));
			pblock->GetValue(noise_function_type, 0, noiseFunction,
			                 Interval(TimeValue(0x80000000), TimeValue(0x7fffffff)));
			pblock->GetValue(fractal_type, 0, fractalFunction, Interval(TimeValue(0x80000000), TimeValue(0x7fffffff)));
...
RefTargetHandle BerconNoise::GetReference(int i)
{
	...
	case CURVE_REF: return cc_curve;
...
void BerconNoise::SetReference(int i, RefTargetHandle rtarg)
{
	switch (i)
	{
	case COORD_REF: pbXYZ = static_cast<IParamBlock2 *>(rtarg);
		break;
	case PBLOCK_REF: pblock = static_cast<IParamBlock2 *>(rtarg);
		break;
	case OUTPUT_REF: texout = static_cast<TextureOutput *>(rtarg);
		break;
	case CURVE_REF: cc_curve = static_cast<ICurveCtl *>(rtarg);
		break;
	case CURVEPB_REF: pbCurve = static_cast<IParamBlock2 *>(rtarg);
		break;
	case PBMAP_REF: pbMap = static_cast<IParamBlock2 *>(rtarg);
		break;
	default: subtex[i - 2] = static_cast<Texmap *>(rtarg);
		break;
	}
}
...
RefTargetHandle BerconNoise::Clone(RemapDir& remap)
{
	...
	*((MtlBase*)mnew) = *((MtlBase*)this); // copy superclass stuff
	...
	mnew->ReplaceReference(CURVE_REF, remap.CloneRef(cc_curve));
...
RefResult BerconNoise::NotifyRefChanged(const Interval&/*changeInt*/, RefTargetHandle hTarget, PartID& /*partID*/,
...
AColor BerconNoise::EvalColor(ShadeContext& sc)
{
	...
	if (useCurve)
	d = cc_curve->GetControlCurve(0)->GetValue(sc.CurTime(), d);
	...
	// Cache
	sc.PutCache(this, c);
	return c; // to what is this returning?
}
...
Point3 BerconNoise::EvalNormalPerturb(ShadeContext& sc)
{
	...
	{
		d = cc_curve->GetControlCurve(0)->GetValue(sc.CurTime(), d);
		normal.x = (cc_curve->GetControlCurve(0)->GetValue(sc.CurTime(), Noise::limitedNoise(p + DELTA * M[0], np)) - d) /
			DELTA;
		normal.y = (cc_curve->GetControlCurve(0)->GetValue(sc.CurTime(), Noise::limitedNoise(p + DELTA * M[1], np)) - d) /
			DELTA; // For removal of custom cc_curve control
		normal.z = (cc_curve->GetControlCurve(0)->GetValue(sc.CurTime(), Noise::limitedNoise(p + DELTA * M[2], np)) - d) /
			DELTA;
	}
	else
	{
